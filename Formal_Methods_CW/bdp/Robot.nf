...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(Robot),Teleport)==(teleport_x_position: NATURAL1 & teleport_y_position: NATURAL1 & teleport_x_position: x_axis_range & teleport_y_position: y_axis_range);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(Robot),Teleport)==(teleport_x_position: NATURAL1 & teleport_y_position: NATURAL1 & teleport_x_position: x_axis_range & teleport_y_position: y_axis_range | teleport_x_position|->teleport_y_position: internal_walls ==> output:=Maze_Wall_Crash [] not(teleport_x_position|->teleport_y_position: internal_walls) ==> (size(visited_squares) = 1 ==> output:=Cannot_Teleport_Immediately [] not(size(visited_squares) = 1) ==> (teleport_x_position|->teleport_y_position: maze ==> output:=Cannot_Teleport_Immediately [] not(teleport_x_position|->teleport_y_position: maze) ==> (teleport_x_position|->teleport_y_position/=(robot_x_position|->robot_y_position) ==> output:=Cannot_Teleport_Immediately [] not(teleport_x_position|->teleport_y_position/=(robot_x_position|->robot_y_position)) ==> robot_x_position,robot_y_position,output:=teleport_x_position,teleport_y_position,Teleported))));
  ...
  List_Substitution(Machine(Robot),Teleport)==(IF teleport_x_position|->teleport_y_position: internal_walls THEN output:=Maze_Wall_Crash ELSIF size(visited_squares) = 1 THEN output:=Cannot_Teleport_Immediately ELSIF teleport_x_position|->teleport_y_position: maze THEN output:=Cannot_Teleport_Immediately ELSIF teleport_x_position|->teleport_y_position/=(robot_x_position|->robot_y_position) THEN output:=Cannot_Teleport_Immediately ELSE robot_x_position,robot_y_position,output:=teleport_x_position,teleport_y_position,Teleported END);
